...
pub mod game_service_server {
    ...
    pub trait GameService: std::marker::Send + std::marker::Sync + 'static {
        /// Server streaming response type for the StartGame method.
        type StartGameStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::StartGameReply, tonic::Status>,
            >
            + std::marker::Send
            + 'static;
        async fn start_game(
        ...
        ) -> std::result::Result<tonic::Response<Self::StartGameStream>, tonic::Status>;
    }
    #[derive(Debug)]
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/gameservice.GameService/StartGame" => {
                    ...
                    impl<
                        T: GameService,
                    > tonic::server::ServerStreamingService<super::StartGameRequest>
                    for StartGameSvc<T> {
                        type Response = super::StartGameReply;
                        type ResponseStream = T::StartGameStream;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as GameService>::start_game(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "gameservice.GameService";
