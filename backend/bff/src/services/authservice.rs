...
pub mod auth_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn login(
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("authservice.AuthService", "Login"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn refresh_login(
            &mut self,
            request: impl tonic::IntoRequest<super::RefreshLoginRequest>,
        ) -> std::result::Result<
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("authservice.AuthService", "RefreshLogin"));
            self.inner.unary(req, path, codec).await
        }
    }
}
